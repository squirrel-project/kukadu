...
## !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  for irank in range(lrank):
    ...
    rmatrix=mvm_random_matrix.cls_image_files()
    (xdata,nrow2,ncol2)=rmatrix.load(ifile)
  ...
  ## !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    xdatacls.YKernel.yrange=256 # it will be recomputed in classcol_ranges
...
##        xselector_row=np.floor(nfold0*np.random.rand(nrow))
    ...
    # ####################################
        ...
        ## qtest_img=rmatrix.invert(256*qtest)
        ## qpred_img=rmatrix.invert(256*qpred)
